      ...
      <div className="flex h-full min-h-0 flex-col gap-2 py-1 sm:gap-3 sm:py-2">
        ...
        >
          {isLoadingHistory ? (
            ...
            <div className="px-2 py-3 text-sm leading-6 text-stone-500">No image history yet. It will appear here once you enter a prompt.</div>
          ) : (
                ...
                >
                  ...
                  >
                    ...
                    <div className={cn("mt-1 text-xs", active ? "text-stone-500" : "text-stone-400")}>
                      {conversation.turns.length} rounds · {formatConversationTime(conversation.updatedAt)}
                    </div>
