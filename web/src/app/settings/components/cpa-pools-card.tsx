      ...
      <CardContent className="space-y-6 p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Configure a connection first, then query remote accounts on demand and choose to import them into the local account pool.</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            {pools.length > 0 ? <Badge className="rounded-md px-2.5 py-1">{pools.length} connection(s)</Badge> : null}
        ...
        <div className="rounded-xl bg-stone-50 px-4 py-3 text-sm leading-6 text-stone-500">
          ...
          <ul className="mt-1 list-inside list-disc space-y-0.5">
            <li>On page load, the configured CPA connections are read first.</li>
            <li>Clicking "Sync" on a connection first reads the remote account list and shows it for selection in the frontend.</li>
            <li>After confirming the selection, the backend downloads the corresponding access_tokens and imports them into the local account pool.</li>
            <li>The frontend only polls the import progress; it does not participate in the download directly.</li>
          </ul>
        </div>
      </CardContent>
    </Card>
