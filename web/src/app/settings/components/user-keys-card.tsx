        ...
        <CardContent className="space-y-6 p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-500">Create dedicated keys for regular users. Regular users can only access the image page; they cannot view settings or the account pool.</p>
              </div>
            </div>
          ...
          {revealedKey ? (
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm text-emerald-900">
              <div className="font-medium">The new key is shown only once; please save it now:</div>
          ...
          {isLoading ? (
            ...
            <div className="rounded-xl bg-stone-50 px-6 py-10 text-center text-sm text-stone-500">
              No regular user keys yet. Click the button in the top-right corner to create one and share it with others.
            </div>
          ) : (
        ...
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Optionally enter a note name to distinguish different users; a raw key that can only be viewed once is generated on creation.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="E.g.: Designer A, temporary ops account"
      ...
      <Dialog open={Boolean(deletingItem)} onOpenChange={(open) => (!open ? setDeletingItem(null) : null)}>
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Delete the user key "{deletingItem?.name}"? After deletion, this key can no longer call the API.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
      ...
      >
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              You can change the note name; to replace the dedicated key, simply enter the new raw key. Leave it empty to keep the current key unchanged.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs leading-5 text-stone-500">
                After saving, the old key becomes invalid immediately and the new key takes effect. The system still stores only the hash and never shows the current key.
              </p>
            </div>
          </div>
          <DialogFooter>
