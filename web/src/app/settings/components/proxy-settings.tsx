          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">
                Configures an egress proxy for chatgpt.com requests, suitable for deployments on servers in China; Sub2API / CPA requests are unaffected.
              </p>
            </div>
          </div>
        </div>
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-stone-200 bg-white px-4 py-3">
              ...
              <div className="space-y-0.5">
                ...
                <div className="text-sm text-stone-500">
                  When disabled, chatgpt.com requests connect directly. Takes effect immediately after saving; no restart required.
                </div>
              </div>
            </label>
