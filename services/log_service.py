...
class LoggedCall:
    ...
    async def run(self, handler, *args, sse: str = "openai"):
        ...
        try:
            ...
            self.log("Call failed", status="failed", error=str(exc), account_email=getattr(exc, "account_email", ""),
    ...
    def stream(self, items):
        ...
        try:
            ...
            if not failed:
                self.log("Streaming call ended", urls=urls, account_email=account_emails[0] if account_emails else "",
