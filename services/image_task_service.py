        ...
        try:
            ...
            if not isinstance(data, list) or not data:
                ...
                if upstream:
                    ...
                    message = "No available accounts in the pool or all accounts are rate limited. Please check the pool status (account quota, banned accounts, image generation limit reached)"
    ...
    def _run_resume_poll(
        ...
        try:
            ...
            if not file_ids and not sediment_ids:
                raise RuntimeError(
                    f"No image result found after waiting {extra_timeout_secs}s more."
                )
